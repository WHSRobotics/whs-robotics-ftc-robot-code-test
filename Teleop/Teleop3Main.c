...
#pragma config(Motor,  mtr_S1_C1_1,     driveRightBack, tmotorTetrix, PIDControl, encoder)
#pragma config(Motor,  mtr_S1_C1_2,     driveRightFront, tmotorTetrix, PIDControl)
#pragma config(Motor,  mtr_S1_C2_1,     driveLeftBack, tmotorTetrix, PIDControl, encoder)
#pragma config(Motor,  mtr_S1_C2_2,     driveLeftFront, tmotorTetrix, PIDControl)
...
///////////////////////////INCLUDES////////////////////////////
#include "Teleop3Tasks.c" //Tele-op tasks
...
task main()
{
  ...
  while (true)
  {
    ...
    motor[driveLeftFront] = driveLeftPwr;
    motor[driveLeftBack] = driveLeftPwr;
    motor[driveRightFront] = driveRightPwr;
    motor[driveRightBack] = driveRightPwr;
  }
}
