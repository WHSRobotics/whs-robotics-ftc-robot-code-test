...
task main()
{
	...
	moveArc(0.0, 180.0, 75.0); //turn perpendicular to the ramp
	StartTask(ScoreArm); //lift the arm to score
	moveStraight(0.0, 34.0, 75.0); //move horizontally onto ramp
	moveStraight(90.0, 10.0, 75.0); //move vertically near crate
	dropTheBlock();
	while(true){}
}
