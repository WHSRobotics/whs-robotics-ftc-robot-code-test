...
task main()
{
	...
	moveArc(0.0, 90.0, -75.0); //turn perpendicular to the ramp
	StartTask(ScoreArm); //lift up arm to score
	moveStraight(180.0, 38.0, 75.0); //move horizontally onto ramp
	moveStraight(90.0, 12.0, 75.0); //move vertically near crate
	dropTheBlock();
	while(true){}
}
